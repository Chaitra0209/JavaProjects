...
public TaskBean()
{
	//For a class to be called a Bean, that class must have instance variables, setters getters, 
	// must have a public no argument constructor, must belong to a package
}
